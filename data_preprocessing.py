...
words=['ani', 'anyon', 'are', 'awesom', 'be', 'best', 'bluetooth', 'bye', 'camera', 'can', 'chat'] #list of unique roots words in the data
classes = ['Hi' , 'There'] #list of unique tags in the data
pattern_word_tags_list = ['words', 'of', 'the', 'sentence', 'tags'] #list of the pair of (['words', 'of', 'the', 'sentence'], 'tags')
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in data['intents']:
        ...
        for pattern in intent['patterns']:  
            ...
            tokenized_words_list = nltk.word_tokenize(pattern_word_tags_list)
